...
import { REDUX_TOPICS_ARRAY } from "../topics-data.js";
...
export default function ReduxPage() {
  ...
  const topicHandler = (topic) => {
    ...
    const selectedTopicId = REDUX_TOPICS_ARRAY.findIndex(
      (e) => e.id === topic.id
    );
  ...
  return (
    <>
      ...
      <section className="grid grid-cols-3">
        <div>
          <SideBar
            topicsArray={REDUX_TOPICS_ARRAY}
        ...
        <div className="col-span-2 max-w-[600px] lg:max-w-[1200px] mr-10 md:mr-12 lg:mr-20">
          <TableOfContents
            topics={REDUX_TOPICS_ARRAY[topicIndex].subTopics}
            textsPosition="left"
          />
