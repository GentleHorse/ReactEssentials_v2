...
import { ADVANCED_TOPICS_ARRAY } from "../topics-data.js";
...
export default function AdvancedPage() {
  ...
  const topicHandler = (topic) => {
    ...
    const selectedTopicId = ADVANCED_TOPICS_ARRAY.findIndex(
      (e) => e.id === topic.id
    );
  ...
  return (
    <>
      ...
      <section className="grid grid-cols-3">
        <div>
          <SideBar
            topicsArray={ADVANCED_TOPICS_ARRAY}
        ...
        <div className="col-span-2 max-w-[600px] lg:max-w-[1200px] mr-10 md:mr-12 lg:mr-20">
          <TableOfContents
            topics={ADVANCED_TOPICS_ARRAY[topicIndex].subTopics}
            textsPosition="left"
          />

          <ul>
            <TopicWrapper topics={ADVANCED_TOPICS_ARRAY[topicIndex].subTopics} />
          </ul>
        </div>
      </section>
