...
export const BASICS_TOPICS_ARRAY = [
  ...
  },
  {
    ...
    subTopics: [
      ...
      {
        id: "sbtp3",
        title: "Outsourcing images import",
        text: `If you need to import multiple images into files for multiple times, it’s redundant to import at each time. So it’s a good practice to create one import file and use it.`,
        code: `
      // File structure

      // src > assets > constructing.png
      // src > assets > cooking.png
      // src > assets > family-time.png
      // src > assets > playing-guitar.png
      // src > assets > romantic-walk.png
      // src > assets > working-on-computer.png
      // src > assets > working-out.png
      ...
      // When you want to import the above image array (for instance)
...
export const REACT_ROUTER_TOPICS_ARRAY = [
  ...
  },
  {
    ...
    subTopics: [
      ...
      {
        id: "sbtp6",
        title: "Reusable modal for react router",
        text: `Here is one of the best practices of modal component.`,
        code: `
      // index.html ------------------------------------------------------------------------
      ...
      // SomeComponent.jsx -----------------------------------------------------------------
          ...
          <Modal onClose={() => navigate("../")}> .... </Modal>

          // When the modal closes, it brings back to the one level higher route	
        `,
      },
    ],
  },
